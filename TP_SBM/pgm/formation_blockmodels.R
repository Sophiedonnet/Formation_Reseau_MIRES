...
inventory_species <- read.csv("D:/WORK_ALL/RECHERCHE/FORMATION_RECHERCHE/FORMATION_RESEAUX/2019_06_MIRES/TP_SBM/data/Vanuatu/inventory_species.csv", row.names=1)
...
Q = which.max(sbm.bern$ICL)
Q


## ----extract param SBM, echo=TRUE, eval = TRUE---------------------------
paramEstimSBM.bern <- extractParamBM(sbm.bern,Q)
...
## ----plot BM network treebin,  echo=TRUE, eval = FALSE-------------------
...
## ----tree fungis plot poiss, echo=TRUE-----------------------------------
